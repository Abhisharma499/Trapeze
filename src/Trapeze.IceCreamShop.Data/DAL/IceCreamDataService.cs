namespace Trapeze.IceCreamShop.Data.DAL
{
    ...
    public class IceCreamDataService : IIceCreamDataService
    {
        ...
        public static async Task<bool> CheckIfIceCreamBaseValid(IceCreamBase iceCreamBase)
        {
            return await Task.FromResult(Enum.IsDefined(typeof(IceCreamBase), iceCreamBase)).ConfigureAwait(false);
        }

        public static async Task<bool> CheckIfIceCreamFlavourValid(IceCreamFlavour iceCreamFlavour)
        {
            return await Task.FromResult(Enum.IsDefined(typeof(IceCreamFlavour), iceCreamFlavour)).ConfigureAwait(false);
        }

        public static async Task<bool> ValidateIceCreamAndFlavourCombination(IReadOnlyCollection<FlavourInformation> flavours, IceCreamBase iceCreamBase)
        {
        ...
        public static async Task<bool> ValidateCookieDoughflavourtheSugarConeBase(FlavourInformation flavour, IceCreamBase iceCreamBase)
        {
        ...
        public static async Task<bool> ValidateFlavourCombination(IReadOnlyCollection<FlavourInformation> allVailableflavours, IReadOnlyCollection<FlavourInformation> selectedFlavours)
        {
        ...
        public static bool ValidateNumberOfScoops(ICollection<FlavourInformation> flavours)
        {
            if (flavours == null)
            {
                return false;
        ...
        public static async Task<decimal> CalculateBaseCost(IceCreamBase iceCreamBase)
        {
        ...
        public static async Task<decimal> CalculateFlavoursCost(ICollection<FlavourInformation> flavours)
        {
            try
            {
                if (flavours == null)
        ...
        public static async Task<bool> ValidatePurChaseTime(DateTime puchaseTime)
        {
            try
            {
        ...
        public static async Task<bool> ValidatePurchaseAmount(decimal userPurchaseAmount, decimal calculatedPurchaseAmount)
        {
            try
            {
        ...
        public static async Task<decimal> CalculateRefund(decimal userPurchaseAmount, decimal calculatedPurchaseAmount)
        {
            try
            {
